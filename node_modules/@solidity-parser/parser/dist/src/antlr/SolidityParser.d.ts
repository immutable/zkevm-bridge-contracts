...
export declare class SolidityParser extends Parser {
    ...
    static readonly RULE_usingForObjectDirective = 19;
    static readonly RULE_userDefinableOperators = 20;
    static readonly RULE_structDefinition = 21;
    static readonly RULE_modifierDefinition = 22;
    static readonly RULE_modifierInvocation = 23;
    static readonly RULE_functionDefinition = 24;
    static readonly RULE_functionDescriptor = 25;
    static readonly RULE_returnParameters = 26;
    static readonly RULE_modifierList = 27;
    static readonly RULE_eventDefinition = 28;
    static readonly RULE_enumValue = 29;
    static readonly RULE_enumDefinition = 30;
    static readonly RULE_parameterList = 31;
    static readonly RULE_parameter = 32;
    static readonly RULE_eventParameterList = 33;
    static readonly RULE_eventParameter = 34;
    static readonly RULE_functionTypeParameterList = 35;
    static readonly RULE_functionTypeParameter = 36;
    static readonly RULE_variableDeclaration = 37;
    static readonly RULE_typeName = 38;
    static readonly RULE_userDefinedTypeName = 39;
    static readonly RULE_mappingKey = 40;
    static readonly RULE_mapping = 41;
    static readonly RULE_mappingKeyName = 42;
    static readonly RULE_mappingValueName = 43;
    static readonly RULE_functionTypeName = 44;
    static readonly RULE_storageLocation = 45;
    static readonly RULE_stateMutability = 46;
    static readonly RULE_block = 47;
    static readonly RULE_statement = 48;
    static readonly RULE_expressionStatement = 49;
    static readonly RULE_ifStatement = 50;
    static readonly RULE_tryStatement = 51;
    static readonly RULE_catchClause = 52;
    static readonly RULE_whileStatement = 53;
    static readonly RULE_simpleStatement = 54;
    static readonly RULE_uncheckedStatement = 55;
    static readonly RULE_forStatement = 56;
    static readonly RULE_inlineAssemblyStatement = 57;
    static readonly RULE_inlineAssemblyStatementFlag = 58;
    static readonly RULE_doWhileStatement = 59;
    static readonly RULE_continueStatement = 60;
    static readonly RULE_breakStatement = 61;
    static readonly RULE_returnStatement = 62;
    static readonly RULE_throwStatement = 63;
    static readonly RULE_emitStatement = 64;
    static readonly RULE_revertStatement = 65;
    static readonly RULE_variableDeclarationStatement = 66;
    static readonly RULE_variableDeclarationList = 67;
    static readonly RULE_identifierList = 68;
    static readonly RULE_elementaryTypeName = 69;
    static readonly RULE_expression = 70;
    static readonly RULE_primaryExpression = 71;
    static readonly RULE_expressionList = 72;
    static readonly RULE_nameValueList = 73;
    static readonly RULE_nameValue = 74;
    static readonly RULE_functionCallArguments = 75;
    static readonly RULE_functionCall = 76;
    static readonly RULE_assemblyBlock = 77;
    static readonly RULE_assemblyItem = 78;
    static readonly RULE_assemblyExpression = 79;
    static readonly RULE_assemblyMember = 80;
    static readonly RULE_assemblyCall = 81;
    static readonly RULE_assemblyLocalDefinition = 82;
    static readonly RULE_assemblyAssignment = 83;
    static readonly RULE_assemblyIdentifierOrList = 84;
    static readonly RULE_assemblyIdentifierList = 85;
    static readonly RULE_assemblyStackAssignment = 86;
    static readonly RULE_labelDefinition = 87;
    static readonly RULE_assemblySwitch = 88;
    static readonly RULE_assemblyCase = 89;
    static readonly RULE_assemblyFunctionDefinition = 90;
    static readonly RULE_assemblyFunctionReturns = 91;
    static readonly RULE_assemblyFor = 92;
    static readonly RULE_assemblyIf = 93;
    static readonly RULE_assemblyLiteral = 94;
    static readonly RULE_tupleExpression = 95;
    static readonly RULE_numberLiteral = 96;
    static readonly RULE_identifier = 97;
    static readonly RULE_hexLiteral = 98;
...
export declare class UsingForObjectDirectiveContext extends ParserRuleContext {
    userDefinedTypeName(): UserDefinedTypeNameContext;
    userDefinableOperators(): UserDefinableOperatorsContext | undefined;
    constructor(parent: ParserRuleContext | undefined, invokingState: number);
    get ruleIndex(): number;
    enterRule(listener: SolidityListener): void;
    exitRule(listener: SolidityListener): void;
...
export declare class MappingContext extends ParserRuleContext {
    mappingKey(): MappingKeyContext;
    typeName(): TypeNameContext;
    mappingKeyName(): MappingKeyNameContext | undefined;
    mappingValueName(): MappingValueNameContext | undefined;
    constructor(parent: ParserRuleContext | undefined, invokingState: number);
    get ruleIndex(): number;
    enterRule(listener: SolidityListener): void;
    exitRule(listener: SolidityListener): void;
