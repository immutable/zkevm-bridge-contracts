module axelar::gateway {
    ...
    use axelar::address_utils::{addressToString};
    ...
    public entry fun call_contract(
        ...
        let state = borrow_global_mut<OutgoingContractCallsState>(@axelar);
    ...
    public entry fun approve_contract_call(
        ...
        let contract_calls = borrow_global_mut<IncomingContractCallsState>(@axelar);
