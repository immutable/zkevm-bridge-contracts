...
export interface AxelarExpressExecutableInterface extends utils.Interface {
    functions: {
...
export interface AxelarExpressExecutable extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: AxelarExpressExecutableInterface;
...
//# sourceMappingURL=AxelarExpressExecutable.d.ts.map