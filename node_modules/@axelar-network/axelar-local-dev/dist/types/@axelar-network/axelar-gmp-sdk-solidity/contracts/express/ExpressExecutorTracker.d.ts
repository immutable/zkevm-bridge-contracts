...
export interface ExpressExecutorTrackerInterface extends utils.Interface {
    functions: {
...
export interface ExpressExecutorTracker extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ExpressExecutorTrackerInterface;
...
//# sourceMappingURL=ExpressExecutorTracker.d.ts.map