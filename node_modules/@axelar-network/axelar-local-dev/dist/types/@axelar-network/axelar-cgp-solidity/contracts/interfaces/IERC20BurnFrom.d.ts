...
export interface IERC20BurnFromInterface extends utils.Interface {
    functions: {
        "burnFrom(address,uint256)": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "burnFrom"): FunctionFragment;
...
export interface IERC20BurnFrom extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: IERC20BurnFromInterface;
...
//# sourceMappingURL=IERC20BurnFrom.d.ts.map