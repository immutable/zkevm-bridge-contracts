...
export interface ProxyInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "implementation" | "init" | "setup"): FunctionFragment;
...
export interface Proxy extends BaseContract {
    ...
    functions: {
        ...
        init(implementationAddress: PromiseOrValue<string>, newOwner: PromiseOrValue<string>, params: PromiseOrValue<BytesLike>, overrides?: Overrides & {
    ...
    callStatic: {
        implementation(overrides?: CallOverrides): Promise<string>;
        init(implementationAddress: PromiseOrValue<string>, newOwner: PromiseOrValue<string>, params: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<void>;
