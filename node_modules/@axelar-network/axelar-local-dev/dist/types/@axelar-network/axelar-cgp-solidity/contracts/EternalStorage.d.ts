...
export interface EternalStorageInterface extends utils.Interface {
    functions: {
...
export interface EternalStorage extends BaseContract {
...
//# sourceMappingURL=EternalStorage.d.ts.map