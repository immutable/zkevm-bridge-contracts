...
class AxelarRecoveryApi {
    ...
    fetchGMPTransaction(txHash, txLogIndex) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.execGet(this.axelarGMPApiUrl, {
                ...
                .then((data) => data.find((gmpTx) => gmpTx.id.indexOf(txHash) > -1 || gmpTx.call.transactionHash.indexOf(txHash) > -1 // the source transaction hash will be stored at "tx.call.transactionHash", if it is sent from cosmos, otherwise it'll be stored at `tx.id` field.
            ))
                .catch(() => undefined);
        });
    }
    fetchBatchData(chainId, commandId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let batchData;
            batchData = yield this.execPost(this.axelarscanBaseApiUrl, "/batches", {
                commandId,
            })
                .then((res) => res[0])
                .catch(() => null);
            ...
            if (!batchData)
                batchData = this.searchRecentBatchesFromCore(chainId, commandId);
            return batchData;
        });
    }
    searchRecentBatchesFromCore(chainId, commandId, iteration = 0, maxTries = 3, batchId) {
        return __awaiter(this, void 0, void 0, function* () {
            if (iteration > maxTries)
                return null;
            const batchData = yield this.queryBatchedCommands(chainId, batchId).catch(() => null);
            if (!batchData)
                return null;
            ...
            (0, utils_1.sleep)(2);
            return this.searchRecentBatchesFromCore(chainId, commandId, iteration + 1, maxTries, batchData.prevBatchedCommandsId);
        });
    }
     ...
     */
    subscribeToTx(txHash, cb, strategy = DEFAULT_SUBSCRIPTION_STRATEGY) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     */
    subscribeToTxPOLLING(txHash, cb, interval = 30000 // 30 seconds
    ) {
        return __awaiter(this, void 0, void 0, function* () {
