...
/**
 * Get the wallet from the environment variables. If the ROOT_PRIVATE_KEY environment variable is set, use that. Otherwise, use the EVM_MNEMONIC environment variable.
...
function checkWallet() {
    if (process.env.ROOT_PRIVATE_KEY == null) {
        throw new Error('Need to set ROOT_PRIVATE_KEY environment variable.');
    }
}
